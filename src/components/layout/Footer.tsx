...
const Footer: FC<FooterProps> = ({ bottom }) => {
  const isBottom = bottom
    ? 'h-auto flex flex-col justify-end absolute bottom-0 w-full z-10'
    : ''
  return (
    <div className={isBottom}>
      <footer className='bg-white p-4 shadow md:flex md:items-center md:justify-between md:p-6'>
        ...
        <ul className='mt-3 flex flex-wrap items-center text-sm text-gray-500 sm:mt-0'>
          <li className='flex'>
            <svg
              className='mr-4 h-5 w-5 hover:underline md:mr-6'
              fill='currentColor'
              viewBox='0 0 24 24'
              aria-hidden='true'
            >
