...
const DashboardList: FC<ProductProps> = ({ item, handleEditProduct }) => {
  ...
  return (
    <>
      ...
      <tr className='border-b bg-white'>
        ...
        <td className='px-6 py-4'>
          <div className='flex justify-around'>
            <button className='text-green-500' onClick={() => edit(item)}>
              <svg
      ...
      {/* Place the modal here to avoid being a child of <tbody> */}
      {open && (
        <tr>
          <td>
            <DeleteModal
